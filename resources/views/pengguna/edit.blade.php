        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3 mb-0">Form Edit Pengguna</h6>
                </div>
            </div>
                ...
                <form action="{{ route('pengguna.update', $user->id_pengguna) }}" method="POST">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6 mb-4">
                            <div class="input-group input-group-outline is-filled @error('nama') is-invalid @enderror">
                    ...
                    <div class="alert alert-light text-dark border mb-4 text-xs">
                        <i class="material-icons text-sm">info</i> Biarkan password kosong jika tidak ingin mengubahnya.
                    </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="input-group input-group-static @error('role') is-invalid @enderror">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    <option value="koordinator" {{ old('role', $user->role) == 'koordinator' ? 'selected' : '' }}>Koordinator Skripsi</option>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-dark">Perbarui User</button>
